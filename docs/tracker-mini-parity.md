...
| DAW integration | Ableton-style clip launcher and Live bridge | Partial | Clip launcher scenes are now modeled and editable as an optional scene x track workflow. Live push/pull/clear remains deferred to the bridge issue. | #87, #89 |
