...
| Instruments | Reusable instrument preset files | Supported | `:preset instrument save/show/load` exports and imports portable `salieri.instrument-preset.v1` files without deleting existing project resources. | #77, #93 |
