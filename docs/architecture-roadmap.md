...
trk currently contains about 26.8k lines of Rust across 21 source and test files. Most behavior is concentrated in a few modules:

| File | July 2026 lines | Hard budget | Split issue |
| --- | ---: | ---: | --- |
| `crates/trk-app/src/main.rs` | 9,946 | 1,000 | [#103](https://github.com/delaudio/trk/issues/103) |
| `crates/trk-tui/src/render.rs` | 3,620 | 800 | [#105](https://github.com/delaudio/trk/issues/105) |
| `crates/trk-core/src/model.rs` | 3,194 | 800 | [#107](https://github.com/delaudio/trk/issues/107) |
| `crates/trk-interop/src/lib.rs` | 2,646 | 800 | [#111](https://github.com/delaudio/trk/issues/111) |
| `crates/trk-audio/src/lib.rs` | 2,047 | 800 | [#109](https://github.com/delaudio/trk/issues/109) |
| `crates/trk-app/src/playback_runtime.rs` | 1,691 | 1,000 | [#108](https://github.com/delaudio/trk/issues/108) |
...
The comparison project, Yazi, demonstrates that a larger Rust application can keep files focused by separating configuration, parsing, actions, domain state, rendering, scheduling, runners, terminal integration, and shared types. trk should adopt the boundaries that address demonstrated pressure rather than reproduce Yazi's crate count or runtime design.
...
terminal / CLI / config
          |
          v
trk-app actions and typed commands
    |        |         |          |
    v        v         v          v
...
- A plugin runtime, scripting language, or dynamic actor registry before a
  concrete product requirement and recorded architecture decision.
...
- Exact structural parity with Yazi; its file manager domains and plugin lifecycle are not trk requirements.

## Delivery Order

### 1. Guardrails

- [#101](https://github.com/delaudio/trk/issues/101): file and module size budgets.
- [#113](https://github.com/delaudio/trk/issues/113): dependency direction and ownership rules.
- [#112](https://github.com/delaudio/trk/issues/112): refactor-safe fixtures and snapshots.

The first two controls prevent new debt. The fixture work supplies behavioral evidence before code movement begins.

### 2. Typed Boundaries

- [#102](https://github.com/delaudio/trk/issues/102): typed command parser and executor.
- [#114](https://github.com/delaudio/trk/issues/114): configuration and preferences boundary.
- [#104](https://github.com/delaudio/trk/issues/104): app event and action dispatcher.
- [#110](https://github.com/delaudio/trk/issues/110): cancellable task runtime.
- [#106](https://github.com/delaudio/trk/issues/106): configurable keymap layers.
...
- [#111](https://github.com/delaudio/trk/issues/111): isolate interop formats and diagnostics.
- [#109](https://github.com/delaudio/trk/issues/109): isolate audio backend, sampler, DSP, render, and export code.
- [#108](https://github.com/delaudio/trk/issues/108): isolate playback transport and scheduling.
- [#105](https://github.com/delaudio/trk/issues/105): split TUI views and widgets.
- [#107](https://github.com/delaudio/trk/issues/107): split core model domains without changing serialization.
- [#103](https://github.com/delaudio/trk/issues/103): finish app decomposition around the typed boundaries above.
