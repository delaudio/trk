...
| `packages/ai` | Provider-backed generation, critique, revise | Partial | Tracker supports explicit, reviewable AI proposals and persisted chat sessions. Full report/critique/revision workflows remain tracked post-MVP. | #68, #69, #70, #98 |
...
| Analyze/compare style | `analyze`, `compare`, style profiles, song comparison | Tracked | Useful for tracker projects once `.salieri` analysis outputs are defined. | #90 |
| Reports, critique, revise | `critique`, `report`, `revise`, durable report artifacts | Tracked | Tracker AI changes must remain reviewable before mutation; report and revision workflows should build on that boundary. | #98 |
| Workspace artifacts | `.salieri.json`, arbitrary workspace roots, save destinations, reports/sets/presets directories | Tracked | Tracker has workspace/project libraries and config paths, but portable artifact roots and conflict handling need a dedicated tracker design. | #94, delaudio/salieri#28, delaudio/salieri#29, delaudio/salieri#39, delaudio/salieri#40 |
...
| Preset and device inventory | Source preset save/load/list/analyze and inventory work | Tracked | Tracker should focus on reusable sample-backed instruments and device inventory useful to local projects. | #77, #93, delaudio/salieri#8, delaudio/salieri#10, delaudio/salieri#11 |
| Research dossiers and operational palettes | Source `research`, tutorial dossiers, prompt/profile assets | Tracked | Useful as optional composition context, but should not be required for normal tracker editing. | #92, delaudio/salieri#11, delaudio/salieri#16 |
| Lyrics | Source lyrics roadmap and MusicXML fixture examples | Tracked | Text-note and lyrics surfaces need a tracker-native model before import/export claims. | #96, delaudio/salieri#25 |
| Strudel/live coding | Source Strudel export target proposal | Tracked | Export-only workflow; should not change the canonical `.salieri` project model. | #97, delaudio/salieri#20 |
