...
| Clip launcher | Source Ableton-oriented scene/clip thinking | Implemented / Partial | Tracker has serializable clip scenes, a terminal scene x track launcher view, queued/active/empty/muted states, and non-destructive clip commands. Ableton bridge mapping remains separate. | #87, #89 |
