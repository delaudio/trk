use trk_core::{Cursor, DelaySpec, EffectDevice, NoteEvent, Song};
        ...
        render_snapshot(
            ...
            TuiState {
                cursor: Cursor {
                    row: 4,
                    track: 1,
                    field: trk_core::CellField::Velocity,
                    digit: 1,
                },
        ...
        render_snapshot(
            ...
            TuiState {
                cursor: Cursor {
                    row: 4095,
                    track: 11,
                    field: trk_core::CellField::Effect,
                    digit: 1,
                },
                row_offset: 4088,
                track_offset: 8,
...
fn snapshots_focused_note_pattern_fields() {
    let tracker_layout = trk_tui::TrackerLayoutState {
        ...
        render_snapshot(
            ...
            TuiState {
                cursor: Cursor {
                    row: 4,
                    track: 3,
                    field: trk_core::CellField::Instrument,
                    digit: 1,
                },
                selection: Some(SelectionRect {
                    row_start: 3,
...
fn snapshots_renoise_demo_project_browser() {
    let entries = [
        ...
        ProjectBrowserEntryView {
            name: "DemoSong - Daed - Bears.trk",
            path: "fixtures/local/renoise-demos/Songs/DemoSong - Daed - Bears.trk",
            kind: ProjectBrowserEntryKind::Project,
            detail: "DemoSong | imported local Renoise demo | samples external",
        },
        ProjectBrowserEntryView {
            name: "Tutorial - Beat Synced Wobbles.trk",
            path: "fixtures/local/renoise-demos/Tutorial/Tutorial - Beat Synced Wobbles.trk",
            kind: ProjectBrowserEntryKind::Project,
        ...
        render_snapshot(
            ...
            TuiState {
                ...
                sampler_view: Some(SamplerViewState {
                    ...
                    selected_envelope: trk_tui::SamplerEnvelopeField::Attack,
                }),
                ..test_state()
            },
            100,
