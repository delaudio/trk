    ...
    match kind {
        RnboWorkflowKind::CppSourceExport => RnboWorkflowAssessment {
            ...
            notes: vec![
                ...
                "store only trk descriptors and parameters until a schema ADR exists",
            ],
        },
        RnboWorkflowKind::WebExportJson => RnboWorkflowAssessment {
            ...
            notes: vec![
                ...
                "do not use @rnbo/js concepts in trk-core",
            ],
        },
        RnboWorkflowKind::CloudPluginBinaryExport => RnboWorkflowAssessment {
            ...
            may_store_project_state_now: false,
            notes: vec![
                "cloud export and binary distribution constraints do not fit trk core",
                "plugin binary export is separate from trk native module data",
            ],
        },
        RnboWorkflowKind::TrkToRnboWrapper => RnboWorkflowAssessment {
            kind,
