...
const WORKSPACE_MANIFEST_SCHEMA: &str = "trk.workspace.v1";
const WORKSPACE_MANIFEST_FILE: &str = ".trk-workspace.json";
...
fn default_workspace_manifest(root: &Path) -> WorkspaceManifest {
    WorkspaceManifest {
        ...
        roots: WorkspaceRoots {
            ...
            trash: PathBuf::from(".trk-trash"),
        },
        favorites: Vec::new(),
        recent_files: Vec::new(),
        naming: WorkspaceNaming {
            project_suffix: ".trk".to_string(),
