...
mod tests {
    ...
    fn ai_thread_round_trips_without_pending_proposals() {
        ...
        let mut thread = default_thread_for_project(Some(Path::new("/tmp/song.trk")));
        ...
        assert_eq!(loaded.linked_project, Some(PathBuf::from("/tmp/song.trk")));
